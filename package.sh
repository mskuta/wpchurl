...
Version: $VERSION
Architecture: all
Depends: php-cli | php5-cli | php7-cli, mariadb-client | mariadb-client-5.5 | mariadb-client-10.0 | mariadb-client-10.1 | mariadb-client-10.3 | mariadb-client-10.4 | mysql-client | mysql-client-5.5 | mysql-client-5.7
